...
****************************************/
const char* UBIDOTS_TOKEN = "BBFF-QpiHdrAzthzMxjMsYUcEa1UtxxvuFM"; // Put here your Ubidots TOKEN
const char* UBIDOTS_DEVICELABEL = "mqtt-publish-esp32"; // Device label to use
...
void loop() {
  ...
  bufferSent = ubidots.send(UBIDOTS_DEVICELABEL); // Will send data to a device label that matches the
  if (bufferSent) {
